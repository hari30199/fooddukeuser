        ...
        
          {
            method: 'POST', 
                ...
                .then((itemstatus) => {
                  ...
                  console.log('Mendal',itemstatus[i].orderstatus.name)
                 })
...
<View style={{ flex: 1, }}>
  ...
  <Icon name="arrow-back-ios" size={24}  onPress={()=>navigation.navigate('Near Me')} style={{left:20,top:25}} />
  <Text style={{
    fontSize:18,
    fontWeight:'500',
    left:40,
...
source={{uri:`${BASEURL}/assets/img/order-placed.gif` }} />
  ...
  <View style={{ justifyContent: 'flex-end' }}/>
        ...
        <TouchableOpacity  
        onPressIn={() =>{Delivery(),handleLikeAnimation()}}>
