...
export const AuthProvider = ({children,props}) => {
  ...
  const register = (name, email, phone,password) => {
    ...
    axios
      .post(`${BASEURL}/public/api/register? name=${name}& email=${email}&phone=${phone}&password=${password}`, {
        name,
        email,
        phone,
        password,
  ...
  const login = (email, password) => {
    ...
    axios
      .post(`${BASEURL}/public/api/login?email=${email}&password=${password}`, {
        email,
        password,
      })
      .then(res => {
...
// console.log('hello',phone)
  ...
  axios
    .post(`${BASEURL}/public/api/login?accessToken=${id}&email=${email}&name=${name}&provider=${provider}&verify_type=${verify_type}&phone=${phone}`, {
   phone
    })
    .then(res => {
      let userInfo = res.data;
...
// console.log(verify_type)
  ...
  const registeradd = (address,latitude,longitude,house,landmark) => {
    ...
    axios
        .post(`${BASEURL}/public/api/save-address?token=${token}&user_id=${id}`, {
        address,
        latitude,
        longitude,
        house,
